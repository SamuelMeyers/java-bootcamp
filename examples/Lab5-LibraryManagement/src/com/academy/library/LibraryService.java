...
public class LibraryService {
    ...
    public void borrowBook() {
        ...
        // Make sure the book is not already borrowed
        if (borrowRecords.containsKey(bookId)) {
        ...
        // Record which member borrowed the book
        borrowRecords.put(bookId, memberId);

        // Add the transaction to borrow history
        ...
        // Increase this book's borrow count
        borrowFrequency.merge(
                bookId,
                1,
                Integer::sum
        );
    ...
    public void returnBook() {
        ...
        // Remove the current loan and get the member who had it
        ...
        // Find the latest open borrow record
