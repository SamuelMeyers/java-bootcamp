...
public class BankService {
    ...
    public void createSavingsAccount() {
        ...
        double initialBalance =
                readPositiveAmount("Initial Balance : ");

        double interestRate =
                readPositiveAmount("Interest Rate : ");
    ...
    public void createCurrentAccount() {
        ...
        double transactionFee =
                readPositiveAmount("Transaction Fee : ");
    ...
    public void deposit() {
        ...
        double amount =
                readPositiveAmount("Deposit Amount : ");
    ...
    public void withdraw() {
        ...
        double amount =
                readPositiveAmount("Withdrawal Amount : ");

        double charge = account.calculateCharges();
