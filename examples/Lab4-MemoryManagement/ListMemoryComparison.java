...
public class ListMemoryComparison {
    ...
    public static void main(String[] args) {
        ...
        long arrayListMemory =
                MemoryMonitor.getUsedMemoryBytes() - before;

        System.out.printf(
                "ArrayList memory approx : %.2f MB%n",
        ...
        long linkedListMemory =
                MemoryMonitor.getUsedMemoryBytes() - before;

        System.out.printf(
                "LinkedList memory approx : %.2f MB%n",
        ...
        System.out.println(
                "ArrayList usually uses less memory per element " +
                        "than LinkedList node overhead."
        );
    }
}